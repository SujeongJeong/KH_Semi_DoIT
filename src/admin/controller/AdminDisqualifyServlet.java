...
/**
 * Servlet implementation class AdminDisqualifyServlet
 */
@WebServlet("/admin/disqualify")
public class AdminDisqualifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminDisqualifyServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i = 0; i < memberNo2.length; i++) {
			result = new AdminService().adminDisqualify(memberNo2[i]);
		}
