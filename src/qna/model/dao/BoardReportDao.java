...
public class BoardReportDao {
	...
	public BoardReportDao() {
		String fileName = BoardReportDao.class.getResource("/sql/board/board-query.xml").getPath();
		try {
	...
	// 게시글 신고
	public int boardReport(Connection conn, BoardReport br) {
		PreparedStatement pstmt = null;
		int result = 0;
		String sql = query.getProperty("reportBoard");
