		...
		<div class="wrap">
			<div class="board_area">
				...
				<div class="board_content">
					<form method="post" action="<%=request.getContextPath()%>/qna/update">
					<!-- 수정할 게시글 id 같이 전달하기 -->
					<input type="hidden" name="board_no" value="${ board.board_no }">
						<div class="contents">
							...
							<span class="input_area"> <input type="text" name="board_title" value= "${ board.board_title }" required>
							</span> <br><br>
							<textarea class="textarea" rows="20" cols="136" name="board_content" id="summernote" required>${ board.board_content }</textarea>
						</div>
						<div class="btn_area">
