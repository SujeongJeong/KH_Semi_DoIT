...
// 저장 된 쿠키 값 가져오기 (cookieName : rememberEmail)
let rememberEmail = getCookie("rememberEmail"); // ★★★
// input 태그에 해당 값 넣기(없을 경우 공백)
userEmail.value = rememberEmail;
...
remember.addEventListener("change", function(){
	if(this.checked){
		...
		setCookie("rememberEmail", userEmail.value, 7);
	} else {
		// ID 저장하기 체크 해제 시
